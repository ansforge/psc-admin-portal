...
describe('InformationDiffComponent', () => {
  ...
  it('should show alerts when some exist', fakeAsync(() => {
  ...
  it('should show get diff when some alerts exist', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
  ...
  it('should show green no alert when no alert exists', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
  ...
  it('should NOT show get diff when no alert exists', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
  ...
  it('should show error panel if alert service unavailable', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
  ...
  it('no diff button if alert service unavailable', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
  ...
  it('When diff downloaded, save as csv', fakeAsync(() => {
    fixture.whenStable().then(() => {
      const req = httpTestingController.expectOne(
        `${environment.API_HOSTNAME}portal/service/alertmanager/api/v2/alerts?receiver=email-notifications`
      );
